...
if __name__ == "__main__":
    agent = EvaluationAgent(model_name="x-ai/grok-3-mini-beta")
    results_file = agent.query_collections(
        "What are the challenges in assessing gene editing outcomes?",
        ["openai_paragraph_openai", "openai_fixed_length_openai"]
    )
