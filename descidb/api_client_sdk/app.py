...
def query_collection(collection_name):
    ...
    db_path = os.path.abspath(os.path.join(script_dir, "../server_scraper_db/database"))
    ...
    if "nvidia" in collection_name.lower():
        ...
        query_embeddings = model.encode(
            user_query_list, instruction=query_prefix, max_length=max_length
        ).tolist()
        values = collection.query(query_embeddings=query_embeddings, n_results=2)
